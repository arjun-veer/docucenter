      ...
      <div className="container mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-2">
            <Link to="/" className="flex items-center gap-2 text-xl font-semibold mb-4">
              ...
              <span>Competitive Exam Hub</span>
            </Link>
            <p className="text-muted-foreground text-sm max-w-md">
              A comprehensive platform for Indian students preparing for competitive exams. Track exam dates, store documents, and manage your preparation journey.
            </p>
          </div>
        ...
        <div className="border-t mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-muted-foreground">
            © {new Date().getFullYear()} Competitive Exam Hub. All rights reserved.
          </p>
